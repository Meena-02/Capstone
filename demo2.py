    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column():
                ...
                ref_images = gr.File(label="Reference Images", type="filepath", file_count="multiple")
                with gr.Row():
        ...
        def validate_and_run(target_image, input_text, prompt_images):
            ...
            prompt_images = [Image.open(p.name).convert('RGB') for p in prompt_images]
        ...
        submit_button.click(
            validate_and_run,
            inputs=[target_image, input_text, ref_images],
        ...
        clear_button.click(
            ...
            inputs=[],
            outputs = [target_image, ref_images, input_text, output_image])
